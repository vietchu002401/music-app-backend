...
public class Mp3Controller {
    ...
    ResponseEntity<ResponseMp3Model> addNewContent(@RequestBody Object req, @RequestParam String id, @RequestParam String auth){
        return mp3Services.addNewContent(req, id, auth);
    }
}
